...
def show_all_users(candidates_list):
    """
    Функция принемает список юзеров и возвращает строку со ВСЕМИ пользователями.
    :return:
    """
    candidates_string = ''
...
def find_user_by_skill(skill, candidates_list):
    """Функция принемает навык и список юзеров. Формирует строку с юзерами у которых есть этот навык
    Возвращает эту строку или сообщение что юзеров с таким навыком не обнаружено"""
    candidate_string = ''
    for candidate in candidates_list:
